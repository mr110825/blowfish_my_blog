...
draft = false
title = 'CloudFront + ACM証明書で必ずハマるus-east-1制約'
...
| エンドポイント | リージョン |
|---------------|-----------|
| `cloudfront.amazonaws.com` | US East (N. Virginia) |
| `cloudfront-fips.amazonaws.com` | US East (N. Virginia) |
| `cloudfront.global.api.aws` | US East (N. Virginia) |
